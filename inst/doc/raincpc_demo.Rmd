...
The extracted rainfall data could be saved by setting the `write_output` flag to TRUE. The `write.asc` and related functions from *SDMTools* package could also be used to write the RasterLayer to output.
